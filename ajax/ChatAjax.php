<?php
namespace xenice\gpt\ajax;

use xenice\gpt\Ajax;
use xenice\gpt\utils\StreamHandler;
use xenice\gpt\utils\ChatGPT;
...
class ChatAjax extends Ajax
{
    ...
    public function chat()
    {
        ...
        */
        ...
        //r.gadg.n03.285.31.28@gmail.com----NCA8$Wdn4K3Y----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
        ...
        do_action('xenice_gpt_chat_ajax', $chat);
